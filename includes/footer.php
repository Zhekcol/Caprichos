...
<div id="session-alert" style="display:none; position:fixed; top:0; left:0; width:100%; background-color: #ffc107; color: black; text-align:center; padding: 15px; z-index: 9999;">
Tu sesión ha expirado. Por favor, <a href="#" onclick="location.reload(); return false;">haz clic aquí para refrescar la página</a>.
</div>
